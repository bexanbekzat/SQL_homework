...
create table Products(ProdcutID int Primary key, ProductName varchar(100), Price DECIMAL(10, 2), Category varchar(50), StockQuantity int)
...
create table Customers2(CustomerID int primary key, FirstName varchar(100), LastName varchar(100), Email varchar(100), Phone varchar(50), Address varchar(255), City varchar(100), State varchar(100), PostalCode varchar(20), Country varchar(100))

insert into Customers2 values(1, 'John', 'Doe', 'johndoe@gmail.com', '555-1234', '123 Elm St', 'New York', 'NY', '10001', 'USA'),
...
Select * from Customers2 as Client
...
Select distinct FirstName, Country from Customers2
...
Select ProductName
  ...
  case
	...
	Select ProductName, StockQuantity, iif(StockQuantity >100, 'yes', 'no') from Products_Discounted
	...
	Select ProductName, Price, iif(Price >1000, 'expensive', 'Affordable') as PriceCategory from Products


	create table Employees2(EmployeeID int primary key, FirstName varchar(50) null, LastName varchar(50) null, DepartmentName varchar(50), Salary DECIMAL(10,2), HireDate DATE, age int, Email varchar(100) null, Country varchar(50))
...
Foreign key(CustomerID)references Products(ProductID))
